    ...
    public partial class ViewMember : System.Web.UI.Page
    {
        ...
        protected void Member()
        {
            ...
            while (dr.Read())
            {
                ...
                PlaceHolder_Data.Controls.Add(new LiteralControl("</td>"));
                PlaceHolder_Data.Controls.Add(new LiteralControl("<td>"));
                PlaceHolder_Data.Controls.Add(new LiteralControl("<a href='UpdateMember.aspx?Member_ID=" + dr["Member_ID"].ToString() + "' class='btn btn-primary'>Update</a> <a href='DeleteMember.aspx?Member_ID=" + dr["Member_ID"].ToString() + "' class='btn btn-danger'>Hapus</a>"));
                PlaceHolder_Data.Controls.Add(new LiteralControl("</td>"));
                PlaceHolder_Data.Controls.Add(new LiteralControl("</tr>"));
            }
            conn.Close();
